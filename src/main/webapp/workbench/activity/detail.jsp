...
<body>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b id="activity-cost">${a.cost}</b></div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 40px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;" ><b id="activity-editBy">${a.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;" id="activity-editTime">${a.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 50px;">
			<div style="width: 300px; color: gray;">描述</div>
			<div style="width: 630px;position: relative; left: 200px; top: -20px;"><b id="activity-description">${a.description}</b></div>
