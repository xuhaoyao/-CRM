...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#clueBody").on("click",$("input[name=choice]"),function(){
	...
	function pageList(pageNo,pageSize){
		...
		var source = $("#search-source option:selected").text();
...
<%--						<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=81bba67b3a294eb8936615206e87ad5a';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
